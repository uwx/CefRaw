...
public unsafe partial struct _cef_run_context_menu_callback_t
{
    ...
    public delegate* unmanaged[Stdcall]<_cef_run_context_menu_callback_t*, int, cef_event_flags_t, void> cont;

    [NativeTypeName("void (*)(struct _cef_run_context_menu_callback_t *) __attribute__((stdcall))")]
    public delegate* unmanaged[Stdcall]<_cef_run_context_menu_callback_t*, void> cancel;
}
