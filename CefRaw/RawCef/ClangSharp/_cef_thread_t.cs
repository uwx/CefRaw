...
public unsafe partial struct _cef_thread_t
{
    ...
    public delegate* unmanaged[Stdcall]<_cef_thread_t*, _cef_task_runner_t*> get_task_runner;

    [NativeTypeName("cef_platform_thread_id_t (*)(struct _cef_thread_t *) __attribute__((stdcall))")]
    public delegate* unmanaged[Stdcall]<_cef_thread_t*, nuint> get_platform_thread_id;

    [NativeTypeName("void (*)(struct _cef_thread_t *) __attribute__((stdcall))")]
    public delegate* unmanaged[Stdcall]<_cef_thread_t*, void> stop;

    [NativeTypeName("int (*)(struct _cef_thread_t *) __attribute__((stdcall))")]
    public delegate* unmanaged[Stdcall]<_cef_thread_t*, int> is_running;
}
