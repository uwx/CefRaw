...
public unsafe partial struct _cef_auth_callback_t
{
    ...
    public delegate* unmanaged[Stdcall]<_cef_auth_callback_t*, _cef_string_utf16_t*, _cef_string_utf16_t*, void> cont;

    [NativeTypeName("void (*)(struct _cef_auth_callback_t *) __attribute__((stdcall))")]
    public delegate* unmanaged[Stdcall]<_cef_auth_callback_t*, void> cancel;
}
