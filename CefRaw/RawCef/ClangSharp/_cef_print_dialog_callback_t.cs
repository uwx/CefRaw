...
public unsafe partial struct _cef_print_dialog_callback_t
{
    ...
    public delegate* unmanaged[Stdcall]<_cef_print_dialog_callback_t*, _cef_print_settings_t*, void> cont;

    [NativeTypeName("void (*)(struct _cef_print_dialog_callback_t *) __attribute__((stdcall))")]
    public delegate* unmanaged[Stdcall]<_cef_print_dialog_callback_t*, void> cancel;
}
