...
{
    public _cef_browser_settings_t* NativePtr { get; }
}

public unsafe partial class CefBrowserSettings
{
    private readonly _cef_browser_settings_t* _ptr;

    public CefBrowserSettings(_cef_browser_settings_t* ptr)
    {
        _ptr = ptr;
        Initialize();
    }
    ...
    public _cef_browser_settings_t* NativePtr => _ptr;
