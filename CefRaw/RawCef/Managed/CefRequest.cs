...
public unsafe partial class CefRequest : CefBaseRefCounted
{
    private readonly _cef_request_t* _ptr;

    public CefRequest(_cef_request_t* ptr) : base(&ptr->@base)
    {
        _ptr = ptr;
        Initialize();
    }
    ...
    internal _cef_request_t* NativePtr => _ptr;
    ...
    public CefPostData GetPostData()
    {
        ...
        return _result != null ? new CefPostData(_result) : null;
    }

    public void SetPostData(CefPostData? arg0)
    {
    ...
    public void Set(string? arg0, string? arg1, CefPostData? arg2, _cef_string_multimap_t* arg3)
    {
        fixed (char* _p0 = arg0)
        fixed (char* _p1 = arg1)
        {
