...
/// <summary>
/// Abstract base class for client-side implementations of <c>_cef_dictionary_value_t</c>.
/// Subclass this to implement a custom CefDictionaryValue.
/// </summary>
public unsafe abstract partial class CefDictionaryValue : CefBaseRefCounted, ICefDictionaryValue
{
    private _cef_dictionary_value_t* _typedPtr;

    protected CefDictionaryValue() : this((nuint)sizeof(_cef_dictionary_value_t))
    {
    }

    protected CefDictionaryValue(nuint structSize) : base(structSize)
    {
        _typedPtr = (_cef_dictionary_value_t*)NativePtr;
        InitializeNativeStruct();
    }

    _cef_dictionary_value_t* ICefDictionaryValue.NativePtr => _typedPtr;
    ...
    protected override void InitializeNativeStruct()
    {
        ...
        _typedPtr->has_key = &Bridge_HasKey;
    ...
    /// </summary>
    public abstract int IsSame(ICefDictionaryValue? arg0);

    /// <summary>
    /// Implement the <c>is_equal</c> callback.
    /// </summary>
    public abstract int IsEqual(ICefDictionaryValue? arg0);

    /// <summary>
    /// Implement the <c>copy</c> callback.
    /// </summary>
    public abstract ICefDictionaryValue? Copy(int arg0);
    ...
    /// <summary>
    /// Implement the <c>has_key</c> callback.
    /// </summary>
    public abstract int HasKey(string? arg0);
    ...
    /// </summary>
    public abstract int Remove(string? arg0);

    /// <summary>
    /// Implement the <c>get_type</c> callback.
    /// </summary>
    public abstract cef_value_type_t GetType(string? arg0);

    /// <summary>
    /// Implement the <c>get_value</c> callback.
    /// </summary>
    public abstract ICefValue? GetValue(string? arg0);

    /// <summary>
    /// Implement the <c>get_bool</c> callback.
    /// </summary>
    public abstract int GetBool(string? arg0);
    ...
    /// </summary>
    public abstract ICefBinaryValue? GetBinary(string? arg0);

    /// <summary>
    /// Implement the <c>get_dictionary</c> callback.
    /// </summary>
    public abstract ICefDictionaryValue? GetDictionary(string? arg0);

    /// <summary>
    /// Implement the <c>get_list</c> callback.
    /// </summary>
    public abstract ICefListValue? GetList(string? arg0);

    /// <summary>
    /// Implement the <c>set_value</c> callback.
    /// </summary>
    public abstract int SetValue(string? arg0, ICefValue? arg1);

    /// <summary>
    /// Implement the <c>set_null</c> callback.
    /// </summary>
    public abstract int SetNull(string? arg0);

    /// <summary>
    /// Implement the <c>set_bool</c> callback.
    /// </summary>
    public abstract int SetBool(string? arg0, int arg1);

    /// <summary>
    /// Implement the <c>set_int</c> callback.
    /// </summary>
    public abstract int SetInt(string? arg0, int arg1);

    /// <summary>
    /// Implement the <c>set_double</c> callback.
    /// </summary>
    public abstract int SetDouble(string? arg0, double arg1);

    /// <summary>
    /// Implement the <c>set_string</c> callback.
    /// </summary>
    public abstract int SetString(string? arg0, string? arg1);

    /// <summary>
    /// Implement the <c>set_binary</c> callback.
    /// </summary>
    public abstract int SetBinary(string? arg0, ICefBinaryValue? arg1);

    /// <summary>
    /// Implement the <c>set_dictionary</c> callback.
    /// </summary>
    public abstract int SetDictionary(string? arg0, ICefDictionaryValue? arg1);

    /// <summary>
    /// Implement the <c>set_list</c> callback.
    /// </summary>
    public abstract int SetList(string? arg0, ICefListValue? arg1);
