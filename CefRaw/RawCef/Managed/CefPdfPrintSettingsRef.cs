...
/// <summary>
/// Wraps a library-owned instance of <c>_cef_pdf_print_settings_t</c>.
/// </summary>
public unsafe partial class CefPdfPrintSettingsRef : ICefPdfPrintSettings
{
    private readonly _cef_pdf_print_settings_t* _ptr;

    public CefPdfPrintSettingsRef(_cef_pdf_print_settings_t* ptr)
    {
        _ptr = ptr;
        Initialize();
    }
    ...
    _cef_pdf_print_settings_t* ICefPdfPrintSettings.NativePtr => _ptr;
